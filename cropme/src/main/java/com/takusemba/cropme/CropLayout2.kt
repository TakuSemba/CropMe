...
class CropLayout2 @JvmOverloads constructor(
  ...
  init {
    val a = context.obtainStyledAttributes(attrs, R.styleable.CropLayout2, 0, 0)
    ...
    try {
      ...
      scale = a.getInt(R.styleable.CropLayout2_cropme_max_scale, DEFAULT_MAX_SCALE)
    } finally {
      a.recycle()
    }
    ...
    vto.addOnPreDrawListener(object : ViewTreeObserver.OnPreDrawListener {
      ...
      override fun onPreDraw(): Boolean {
        ...
        val animation = GestureAnimation(this@CropLayout2, animator)
        animation.start()
        when {
